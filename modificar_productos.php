...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    ...
    <h3 class="text-center alert alert-primary">Editar Producto</h3>
   
     <?php
        include "modelo/modificar_productos2.php";
        while ($datos=$sql->fetch_object()){ 
          
          ?>
          <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">#Número</label>
    <input type="number" class="form-control" name="id" value="<?= $datos->idproducto ?>"readonly>
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" name="botella" value="<?= $datos->precio ?>">
  </div>
